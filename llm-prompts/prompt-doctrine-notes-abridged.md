Produce an abridged version of the sermon transcript from the source material.

Goal:
Create a shorter, cleaner transcript-shaped note that preserves the full doctrinal substance of the teaching while reducing repetition, transcript drag, and non-essential spoken clutter. The result should still read like a transcript-based teaching note, not like a summary, article, or study guide.

Instructions:
- Do NOT turn the transcript into bullet points, article prose, or a study-note outline.
...
- Do not flatten distinct teaching movements into vague condensed prose.
...
- Then present the abridged sermon body as cleaned transcript text.
